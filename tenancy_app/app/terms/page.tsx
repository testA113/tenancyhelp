    ...
    <div className="mx-auto max-w-2xl px-4 mt-20">
      <Card>
        <div>
          <div>
            <h1>
              Terms and Conditions of <strong>www.tenancyhelp.com</strong>
            </h1>
          ...
          <p>
            <b>Owner contact email:</b> aliharriss1995@gmail.com
          </p>
          ...
          <ul>
            <li>
              Minors may access this Application and use its Service only under
          ...
          <ul>
            <li>
              Minors may only use this Application under parental or adult
              supervision;
            </li>
          </ul>
          ...
          <p>
            ...
            <strong>
              ...
              to this Application or the Service, terminating contracts,
              reporting any misconduct performed through this Application or the
          ...
          <p>
            Unless otherwise explicitly stated or agreed with Users, the
            Owner&apos;s liability for damages in connection with the execution
            of the Agreement shall be excluded, limited and/or reduced to the
          ...
          <p>
            ...
            Personal Data or information and will respect Users&apos; rights
            relating to continued product use and/or compensation, as provided
            ...
            <div>
              ...
              <div>
                ...
                <p>
                  ...
                  any other related documents or agreements, and as updated from
                  time to time.
                </p>
                <h4>User (or You)</h4>
                <p>
